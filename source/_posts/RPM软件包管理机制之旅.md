...
%clean部分用来删除打包过程中产生的临时文件。

%changelog用来记录spec文件的改动，在vim的命令模式下可以输入`\\c`来快速地插入作者信息及时间戳。
...
- 鸟哥的Linux私房菜——基础学习篇，第三版，22章。  
- YUM文档：[http://yum.baseurl.org/wiki/Guides](http://yum.baseurl.org/wiki/Guides)  
- Fedora RPM Guide：[http://docs.fedoraproject.org/en-US/Fedora\_Draft\_Documentation/0.1/html/RPM_Guide/index.html](http://docs.fedoraproject.org/en-US/Fedora_Draft_Documentation/0.1/html/RPM_Guide/index.html)  
- Maximum RPM：[http://ishare.iask.sina.com.cn/f/37848528.html](http://ishare.iask.sina.com.cn/f/37848528.html)  
- HLFS Project Home：[http://code.google.com/p/cloudxy/](http://code.google.com/p/cloudxy/)